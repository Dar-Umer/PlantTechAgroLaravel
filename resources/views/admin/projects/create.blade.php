...
@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <x-admin.button href="{{ route('admin.projects.index') }}" variant="secondary" icon='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>'>Back</x-admin.button>
        </div>
        ...
        <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="mt-5">
                    <x-admin.input name="video_url" label="YouTube Video Link" :value="old('video_url')" placeholder="https://www.youtube.com/watch?v=..." helptext="Optional. If set, the landing page shows the video instead of the image." />
                </div>
            </div>
