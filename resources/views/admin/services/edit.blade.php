            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <x-admin.checkbox name="creates_orchard_on_completion" label="Creates Orchard on Completion" :checked="old('creates_orchard_on_completion', $service->creates_orchard_on_completion)" help="Automatically establishes a verified 'Established by Plant Tech Agro' orchard when completed." />
                    </div>
                </div>
            </div>
