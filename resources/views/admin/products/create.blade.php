            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <x-admin.input name="mrp" label="MRP (₹)" type="number" step="1" min="0" :value="old('mrp')" helptext="For sellables — shown struck through in the catalog." />
                        <x-admin.input name="selling_price" label="Selling Price (₹)" type="number" step="1" min="0" :value="old('selling_price')" helptext="For sellables — blank falls back to rate." />
