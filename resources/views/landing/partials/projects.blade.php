        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($projects as $project)
                ...
                <a href="{{ route('project.show', $project) }}"
                   class="group rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden shadow-sm dark:shadow-none hover:shadow-lg hover:-translate-y-1 transition duration-300 flex flex-col">
